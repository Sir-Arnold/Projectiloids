...
{ 
  ...
  public void makeProjectile(int x, int y, double angle) 
   { 
     handler.addObject(new Projectile((int)(x + radius * Math.cos(angle)) + 2, (int)(y + radius * Math.sin(angle)) + 2, GameObjectID.Projectile, 4, 7.0D, angle, handler, GameObjectID.Player)); 
   } 
